...
<head>
  ...
  <script type="text/javascript">
  	//Start username & Password validation 
    
	function validateusername() {
		var return_val = true;
		var password = document.getElementById("exampleInputPassword").value.trim();
  		var name = document.getElementById("exampleInputEmail").value.trim();
  		document.getElementById("exampleInputPassword").style.borderColor = "white";
  		document.getElementById("exampleInputEmail").style.borderColor = "white";
  		if (name == "") {
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                    ...
                    <?php
                     ...
                     if($_arguments != null){
                      ...
                      if($_arguments["_do"] =="save"){
                        ...
                        $_SESSION["log_email"] =$Username;
                        $_SESSION["log_password"] =md5($password);
                  ...
                  <form class="user" method="post" action="index.php" onsubmit="return validateusername()" target="_self">
                    ...
                    <button type="submit" id="loginBtn" class="btn btn-primary btn-user btn-block py-3 my-4" >Login</button>
                    <hr>
